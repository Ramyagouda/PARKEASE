...
🚗 Smart Parking Management System | Python, OOP, DSA

Developed a console-based Smart Parking Management System using Python and Object-Oriented Programming principles. Implemented efficient parking slot allocation using a Min Heap, O(1) vehicle lookup using Hash Maps, and FIFO waiting queue management using Deque. Added parking fee calculation, receipt generation, dashboard reporting, and robust exception handling. Designed a modular architecture that can be extended for web, mobile, and IoT-based smart parking applications.
